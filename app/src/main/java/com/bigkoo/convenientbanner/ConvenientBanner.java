...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    //add by hsu
    public ConvenientBanner setPageIndicator(int[] page_indicatorId,CBPageChangeListener.OnCBPageSelected mOnCBPageSelected) {
        loPageTurningPoint.removeAllViews();
        mPointViews.clear();
        this.page_indicatorId = page_indicatorId;
        if(mDatas==null)return this;
        ...
        pageChangeListener = new CBPageChangeListener(mPointViews,
                page_indicatorId);
        pageChangeListener.setOnCBPageSelected(mOnCBPageSelected);
        viewPager.setOnPageChangeListener(pageChangeListener);

...
public class CBPageChangeListener implements ViewPager.OnPageChangeListener {
    ...
    private OnCBPageSelected  onCBPageSelected;
    public CBPageChangeListener(ArrayList<ImageView> pointViews,int page_indicatorId[]){
        this.pointViews=pointViews;
        this.page_indicatorId = page_indicatorId;
    }
    public void setOnCBPageSelected(OnCBPageSelected mOnCBPageSelected) {
        this.onCBPageSelected = mOnCBPageSelected;
    }
    @Override
    ...
    public void onPageSelected(int index) {
        ...
        if(onCBPageSelected != null) {
            onCBPageSelected.onPageSelected(index);//add by hsu
        }
    }

    public interface OnCBPageSelected {
        public void onPageSelected(int index);
    }
}

 ...
 */
public class ShortMasterFragment extends BaseFragment {
    private static final String TAG = " ShortMasterFragment ";

    protected String url = Utils.BASE_URL+"Faxian_list/aid/2";
    ...
    public class MasterAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.short_master_list_item,viewGroup,false);

 ...
 */
public class StabMasterFragment extends BaseFragment  {
    private static final String TAG = "StabMasterFragment";

    protected String url = Utils.BASE_URL+"Faxian_list/aid/1";
    ...
    public class MasterAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.stab_master_list_item,viewGroup,false);

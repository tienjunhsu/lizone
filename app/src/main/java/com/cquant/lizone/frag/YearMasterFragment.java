 ...
 */
public class YearMasterFragment extends  BaseFragment {

    private static final String TAG = " SignMasterFragment ";

    protected String url = Utils.BASE_URL+"Faxian_list/aid/4";
    ...
    public class MasterAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.year_master_list_item,viewGroup,false);
